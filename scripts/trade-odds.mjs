// DEPRECATED (copilot track, 2026-09-08). Superseded by:  ff copilot trade-finder / trade-check
//   -- src/inseason/copilot.ts :: tradeFinder / tradeCheck, also served as an MCP tool (docs/mcp.md).
//
