...
export const FEATURE_FIELDS = [
  ...
  "prior_td_oe", "prior_adot",   // volume-orthogonal pbp candidates (2026-09-15)
  "prior_team_pass_rate", "prior_team_plays_pg", "prior_team_rz_pg",   // team-environment candidates (2026-09-15)
